...
def main():
    ...
    # DATA INPUT
    ############
    file_path = "/Users/neerajlaks/Desktop/Python/data analysis with python/AI Singapore Certification/Regression Project/house-prices-advanced-regression-techniques/train.csv" #TASK: Modify to path of file
